...
| **[@AQuant1](https://github.com/AQuant1)** | [10.05]   | [2e1fbb5](https://github.com/MoritzDav/sopra-fs26-group-04-client/pull/77) | Added Select Whiteboard tab bar for the teacher | So the teacher can switch between own board and each student's board |
|                    | [10.05]   | [9d37d37](https://github.com/MoritzDav/sopra-fs26-group-04-client/pull/78) | Live-broadcast of student strokes + clear/text actions on read-only canvas | Teacher sees each student's whiteboard live |
...
| **[@AQuant1](https://github.com/AQuant1)** | [15.05]   | [eb2a6b6](https://github.com/MoritzDav/sopra-fs26-group-04-client/pull/84) | Added Multi-Mode toggle button for the teacher | Teacher needs to enable/disable collaboration mode and visually indicate it to all participants |
|                    | [17.05]   | [aca3635](https://github.com/MoritzDav/sopra-fs26-group-04-client/pull/85) | Live broadcast of student strokes + text on teacher's whiteboard during multi-mode | Students must be able to draw collaboratively on the teacher's board while multi-mode is active |
